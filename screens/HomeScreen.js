import { weatherImages } from '../const/const.js';
import {
...
export default function HomeScreen() {
    ...
    useEffect(()=>{
        fetchMyWeatherData().then(() => {
            console.log("fetchMyWeatherData: ok");
        });
    },[]);
    ...
    return(
        <ImageBackground source={require('../assets/images/bg.png')} resizeMode={"cover"} style={{flex: 1,
            justifyContent: 'center'}} blurRadius={70}>
